...
- [x] Confirm the public NHSBSA finalised Secondary Care Medicines Data route, capture catalogue/resource hashes and OGL terms, and bind its use to context-only promotion with refresh/invalidation contingencies. (`secondary-care-aggregate-receipt-2026-08-03.json`)
...
- [x] Triangulate comparator and national implementation context using independent official publishers or accountable custodians; reject mirrors as corroboration. (`comparator-national-triangulation-2026-08-03.json`, `public-triangulation-supplement-2026-08-03.json`, `conductor/triangulation-contingency-protocol.md`; `c9acad2`)
- [x] Review triangulation provenance, independence, unresolved-field dispositions, and fail-closed boundaries. (`triangulation-review-2026-08-03.json`)
- [x] Run all four Chapter 7 scenarios using synthetic or explicitly labelled public-context assumptions; keep empirical calibration disabled. (`constrained-research-output-2026-08-03.json`, `chapter7-scenario-run-2026-08-03.json`; `3634fd1`)
...
- [x] Validate the future Atlas packet-ingestion, hash-binding, panel-review, and requalification path against exact target artifacts and commit. (`validate_t13_closeout.py`, `panel-review-target-2026-08-03.json`, `atlas-requalification-validation-2026-08-03.json`; `b9bdc35`)
- [x] Review Atlas requalification bindings, panel completeness, stale handling, and external-gate visibility. (`atlas-requalification-review-2026-08-03.json`)
- [x] Prepare negative/deferred receipts for inaccessible, incomplete, conflicting, and restricted evidence, with explicit fallback and stop conditions. (`contingency-register-2026-08-03.json`, `negative-deferred-receipts-2026-08-03.json`; `e22ed8e`)
- [x] Test stale-source detection and invalidation when URLs, revisions, terms, transformations, or commits change; require reacquisition and requalification. (`stale-source-invalidation-2026-08-03.json`, `gate-resolution-plan-2026-08-03.json`, `validate_t13_closeout.py`; `71c3115`)
- [x] Keep empirical, payer, HTA, policy, regulatory, and calibrated claims disabled until all external gates and packet-bound authorization pass. (`claims-disabled-validation-2026-08-03.json`, `research-readiness-receipt-2026-08-03.json`; `4be84cd`)
