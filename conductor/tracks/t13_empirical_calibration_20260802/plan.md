...
- [x] Perform sensitivity analyses, including Scenario 4 limitation demonstrations and missing time-profile/joint-uncertainty handling. (`method-reconciliation-2026-08-03.md`, `constrained-research-output-2026-08-03.json`, `sensitivity-analysis-2026-08-03.json`)
