...
- [x] Test stale-source detection and invalidation when URLs, revisions, terms, transformations, or commits change; require reacquisition and requalification. (`stale-source-invalidation-2026-08-03.json`, `gate-resolution-plan-2026-08-03.json`, `validate_t13_closeout.py`; `cba9f19`)
