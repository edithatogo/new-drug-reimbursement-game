...
- [ ] Assemble the submission/release candidate at an exact commit.
- [ ] Obtain sponsor and jurisdiction-specific authorization.
- [ ] Completion checkpoint: run full validation without submitting or publishing implicitly.
- [ ] Completion checkpoint: refresh every governing source at the exact validation/submission freeze.
