...
| Licences and provenance | Licence reconciliation for every dependency and derived artifact | Voiage reconciled at its verified pin; Atlas derived-output scope and Hugging Face destination metadata reconciled at the pinned Atlas revision | Preserve the Atlas adjudication and retain source-specific restrictions; no raw-source redistribution |
